...
export const CATEGORIES: Category[] = [
  { id: CategoryId.NATIONAL, label: 'জাতীয়', slug: 'national' },
  { id: CategoryId.INTERNATIONAL, label: 'আন্তর্জাতিক', slug: 'international' },
  { id: CategoryId.POLITICS, label: 'রাজনীতি', slug: 'politics' },
  { id: CategoryId.SPORTS, label: 'খেলাধুলা', slug: 'sports' },
  { id: CategoryId.ENTERTAINMENT, label: 'বিনোদন', slug: 'entertainment' },
  { id: CategoryId.TECH, label: 'প্রযুক্তি', slug: 'tech' },
  { id: CategoryId.ECONOMY, label: 'অর্থনীতি', slug: 'economy' },
  { id: CategoryId.LIFESTYLE, label: 'লাইফস্টাইল', slug: 'lifestyle' },
  { id: CategoryId.OPINION, label: 'মতামত', slug: 'opinion' },
];

export const POPULAR_TAGS = ['নির্বাচন', 'ক্রিকেট', 'ফুটবল', 'আইফোন', 'মুভি', 'বাজেট', 'আবহাওয়া', 'গাজা', 'মেট্রোরেল', 'ডেঙ্গু'];

// Helper to generate slug from Bengali/English text
export const generateSlug = (text: string): string => {
  return text
    .trim()
    .toLowerCase()
    .replace(/\s+/g, '-') // Replace spaces with -
    .replace(/[^\w\u0980-\u09FF-]+/g, '') // Remove non-word chars (keeping Bengali range)
...
export const MOCK_ARTICLES: Article[] = [
  {
    id: '1',
    slug: 'padma-bridge-new-toll-record',
    ...
    tags: ['পদ্মা সেতু', 'উন্নয়ন', 'ঈদ যাত্রা'],
  ...
  {
    id: '2',
    slug: 'global-oil-price-drop-impact',
  ...
  {
    id: '5',
    slug: 'dhaka-rain-winter-forecast',
    ...
    category: CategoryId.NATIONAL,
    tags: ['আবহাওয়া', 'বৃষ্টি', 'শীত'],
    imageUrl: 'https://picsum.photos/seed/news5/800/450',
    views: 5600,
  },
  {
    id: '6',
    slug: 'shakib-khan-new-movie',
    ...
    tags: ['সিনেমা', 'শাকিব খান', 'ঢালিউড'],
    imageUrl: 'https://picsum.photos/seed/news6/800/450',
    views: 35000,
  },
  {
    id: '7',
    slug: 'gaza-humanitarian-aid-crisis',
  ...
  {
    id: '8',
    slug: 'election-commission-new-law',
  ...
  },
  {
    ...
    category: CategoryId.POLITICS,
    tags: ['রাজনীতি', 'সংলাপ', 'দল'],
    imageUrl: 'https://picsum.photos/seed/news9/800/450',
    views: 11000,
  },
  {
    id: '10',
    slug: 'bangladesh-movie-oscars',
  ...
  {
    id: '11',
    slug: 'metro-rail-schedule-update',
  ...
  },
  {
    ...
    category: CategoryId.INTERNATIONAL,
    tags: ['যুক্তরাষ্ট্র', 'নির্বাচন', 'বিশ্ব'],
    imageUrl: 'https://picsum.photos/seed/news12/800/450',
    views: 31000,
  },
  {
    id: '13',
    slug: 'dengue-situation-alert',
